                ...
                <div class="row grid gap-3">
                    <div class="p-2 g-col-6">
                        ...
                        <form action="" class="mb-3">
                            ...
                            <input type="text" id="regnbr" class="form-control mt-2" placeholder="registration number" v-model="car.regnbr">
                            
                            <input type="text" id="brand" class="form-control mt-2" placeholder="brand" v-model="car.brand">
                            
                            <input type="text" id="km" class="form-control mt-2" placeholder="Kilometers" v-model="car.kilometers">
